...
### Shipped: M0 → M20 and M22 (2026-07-05 → 2026-08-16)

Every milestone through M20 is closed, and M22 with them; **M21 is the only one still open**
and is below. The checklists and the full per-pass progress log — what was probed, decided,
and rejected — live in **[docs/HISTORY.md](docs/HISTORY.md)**; source comments citing
