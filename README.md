...
swipe. FTP and FTPS join SFTP and SMB in the Servers sidebar, certificates
trusted by fingerprint rather than by disabling verification. Checksum files
create and verify across CRC32, MD5, SHA-1 and SHA-256 — reading every format
