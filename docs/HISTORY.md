# Dirnex — build history (M0 → M7)

The shipped record of Dirnex's first seven milestones, 2026-07-05 → 2026-07-20: the
...
closed, so the plan could go back to being a plan. Nothing here binds current work:
