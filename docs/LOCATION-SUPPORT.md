...
| CSV and TSV as a sortable, zoomable table in preview, with the selected row in full in a resizable strip<sup>sss</sup> | yes | yes | yes | yes | yes | yes | n/a | n/a | yes | yes |
